...
def get_ExpSquaredKernel_gp_params(gp) :
    ...
    """Get Exp Squared Kernel gp params.
...
def set_ExpSquaredKernel_gp_params(gp, params) :
    ...
    """Set Exp Squared Kernel gp params.
...
def ExpSquaredKernel_gp(t, y, yerr,
    ...
    run_optimization : bool, optional (default: True)
    amplitude : float, optional (default: 1.0)
    amplitude_lim : list, optional (default: (0,1e10))
    fix_amplitude : bool, optional (default: False)
    decaytime : int, optional (default: 70)
    decaytime_lim : list, optional (default: (10,300))
    fix_decaytime : bool, optional (default: False)
    fit_mean : bool, optional (default: False)
    fit_white_noise : bool, optional (default: False)
    fix_mean : bool, optional (default: False)
    fix_white_noise : bool, optional (default: False)
    amplitude_label : str, optional (default: r"$\alpha$")
    decaytime_label : str, optional (default: r"$l$")
    mean_label : str, optional (default: r"$\mu$")
    white_noise_label : str, optional (default: r"$\sigma$")
    fixpars_before_fit : bool, optional (default: True)
    x_label : str, optional (default: "time")
    y_label : str, optional (default: "y")
    output_pairsplot : str, optional (default: "")
...
def set_star_rotation_priors(gp, period_lim=(1,500), amplitude_lim=(0,1e10), decaytime_lim=(10,300), smoothfactor_lim=(0.1,1.0)) :
    ...
    ----------
    gp
    period_lim : list, optional (default: (1,500))
    amplitude_lim : list, optional (default: (0,1e10))
    decaytime_lim : list, optional (default: (10,300))
    smoothfactor_lim : list, optional (default: (0.1,1.0))
    """
...
def star_rotation_gp(t, y, yerr,
    ...
    r"""Fit a quasi-periodic Gaussian Process (star rotation) to a time series, optionally with MCMC, and return the GP object.
    ...
    yerr
        Array of y uncertainties.
    run_optimization : bool, optional (default: True)
    period : float, optional (default: 10.)
        Period [d].
    period_lim : list, optional (default: (1,500))
    fix_period : bool, optional (default: False)
    amplitude : float, optional (default: 1.0)
    amplitude_lim : list, optional (default: (0,1e10))
    fix_amplitude : bool, optional (default: False)
    decaytime : int, optional (default: 70)
    decaytime_lim : list, optional (default: (10,300))
    fix_decaytime : bool, optional (default: False)
    smoothfactor : float, optional (default: 0.5)
    smoothfactor_lim : list, optional (default: (0.1,1.0))
    fix_smoothfactor : bool, optional (default: False)
    fit_mean : bool, optional (default: False)
    fit_white_noise : bool, optional (default: False)
    fix_mean : bool, optional (default: False)
    fix_white_noise : bool, optional (default: False)
    period_label : str, optional (default: "Prot [d]")
    amplitude_label : str, optional (default: r"$\alpha$")
    decaytime_label : str, optional (default: r"$l$")
    smoothfactor_label : str, optional (default: r"$\beta$")
    mean_label : str, optional (default: r"$\mu$")
    white_noise_label : str, optional (default: r"$\sigma$")
    fixpars_before_fit : bool, optional (default: True)
    x_label : str, optional (default: "time")
...
def star_rotation_gp_freeze_all_params(gp) :
    """Star rotation gp freeze all params.
...
def star_rotation_gp_thaw_all_params(gp) :
    """Star rotation gp thaw all params.
...
def get_star_rotation_gp_params(gp) :
    ...
    """Extract the hyperparameters of a star-rotation GP into a dictionary.
...
def set_star_rotation_gp_params(gp, params) :
    ...
    """Set the hyperparameters of a star-rotation GP from a dictionary.
...
def plot_gp_timeseries(bjds, y, yerr, gp, fold_period, phase_plot=True, timesampling=0.001, ylabel=r"Relative flux", number_of_free_params=0) :
    ...
    ylabel : str, optional (default: r"Relative flux")
    ...
    axes[1].plot(bjds, np.zeros_like(bjds),':', color='k', alpha=0.8)
    axes[1].set_xlabel("Time [BJD]", fontsize=16)
...
def interp_gp(wl_out, wl_in, flux_in, fluxerr_in, good_windows, verbose=False, plot=False) :
    ...
    """Interpolate a time series onto new times using a Gaussian Process fit.
